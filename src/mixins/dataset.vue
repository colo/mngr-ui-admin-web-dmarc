...
export default {
  ...
  created () {
    ...
    // this.$options['charts'][this.id].__length = this.dataset.length
    ...
    __set_dataset_data: function (data) {
      ...
      */
      ...
      if (this.buffer === true) {
        ...
        if (!isNaN(slice)) { this.$options['charts'][this.id].dataset_data = this.$options['charts'][this.id].dataset_data.slice(0, slice) }
